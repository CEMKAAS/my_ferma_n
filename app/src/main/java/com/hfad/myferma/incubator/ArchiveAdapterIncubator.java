...
public class ArchiveAdapterIncubator extends RecyclerView.Adapter<ArchiveAdapterIncubator.ViewHolder> {
    ...
    public ArchiveAdapterIncubator(ArrayList idIncubator, ArrayList nameIncubator, ArrayList typeIncubator, ArrayList dataIncubator, ArrayList arhiveIncubator) {
        this.id = idIncubator;
    ...
    @NonNull
    @Override
    public ArchiveAdapterIncubator.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull ArchiveAdapterIncubator.ViewHolder holder, @SuppressLint("RecyclerView") final int position) {
...
//            }
        ...
        textView1.setText("Завершенно");//Какой день
